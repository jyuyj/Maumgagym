...
public class CommentDAO {
	...
	public ArrayList<CommentDTO> commentList(BoardDTO to){
		
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null; 
		
		ArrayList<CommentDTO> commentLists = new ArrayList<>();
	...
	public int commentInsert(CommentDTO cmtto, MemberDTO mto) {
		  Connection conn = null;
		  PreparedStatement pstmt = null;
		  ResultSet rs = null;
