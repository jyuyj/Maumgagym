...
import com.maumgagym.dto.NewsDTO;
...
public class NewsDAO {
	...
	public ArrayList<NewsDTO> selectAllNews( MemberDTO mto ) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null; 
		
		ArrayList<NewsDTO> arrayList = null;
		try {
	...
	public NewsDTO selectUnReadNewsCount( MemberDTO mto ) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null; 
		NewsDTO nto = new NewsDTO();
	...
	// flag 8 비정상 오류
	// flag 9 서버 오류
	public int updateReadNews( NewsDTO nto ) {
		int flag = 9;
		Connection conn = null;
		PreparedStatement pstmt = null;
		try {
