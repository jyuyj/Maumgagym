...
public class LoginController {
	...
	public String loginAction(@ModelAttribute MemberDTO to, HttpServletRequest request, Model model, HttpSession session) {
		//센션값 주고 전달
	...
	public String kakaologin(@ModelAttribute MemberDTO to, HttpServletRequest request, Model model, HttpSession session) {
