...
public class searchMailsender {
	...
	public ModelAndView idsearchmailok(@ModelAttribute MemberDTO to,HttpServletRequest request, Model model) {
		...
		public ModelAndView passwordsearchmailok(@ModelAttribute MemberDTO to,HttpServletRequest request, Model model) {
