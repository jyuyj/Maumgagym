...
request.setCharacterEncoding( "utf-8" );
	ArrayList<BoardDTO> recommendedList = (ArrayList) request.getAttribute("recommendedList");
	ArrayList<BoardDTO> FacilityBoardCountList = (ArrayList) request.getAttribute("FacilityBoardCountList");
	ArrayList<BoardDTO> weeklyBoardList = (ArrayList) request.getAttribute("weeklyBoardList");
	
	StringBuilder sbRecommendedList = new StringBuilder();
	
 	for( BoardDTO to : recommendedList) {
		int seq = to.getSeq();
	...
	int i = 0;
 	for( BoardDTO to : FacilityBoardCountList) {
 	...
 	for( BoardDTO to : weeklyBoardList) {
