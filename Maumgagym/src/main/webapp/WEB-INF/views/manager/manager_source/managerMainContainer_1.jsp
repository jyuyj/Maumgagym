...
<%@page import="com.maumgagym.dao.MemberDAO"%>  
    <%
      ArrayList<BoardDTO> boardLists = (ArrayList) request.getAttribute("boardList");
      	
      	
      	StringBuilder sbBoard = new StringBuilder();
      		
      	 for( BoardDTO to : boardLists){
      		 int seq = to.getSeq();
      	...
      	ArrayList<BoardDTO> facilityBoardLists = (ArrayList) request.getAttribute("facilityBoardList");

      	StringBuilder sbFacility = new StringBuilder();
      	 
      	 for( BoardDTO to : facilityBoardLists){
      		 int seq = to.getSeq();
      		String title = to.getTitle();
