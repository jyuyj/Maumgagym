...
<%@page import="com.maumgagym.dto.CommentDTO"%>
...
request.setCharacterEncoding("UTF-8");
	...
	BoardDTO to = (BoardDTO)request.getAttribute("bto");
	...
	//System.out.println( "제목 : " + subject );
  	...
  	// 댓글
	ArrayList<CommentDTO> cmtList = (ArrayList)request.getAttribute( "commentList" );
