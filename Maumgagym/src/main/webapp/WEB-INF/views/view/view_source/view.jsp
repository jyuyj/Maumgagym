				...
				<div class="row">
					...
					<div class="col-lg-7 col-12">
						<div class="custom-block-info">
							<!-- 수정&삭제 -->
							<% if( mid.equals( id )) {%>
							<div class="md-6 text-end">
								<input type="button" value="수정" class="btn btn-outline-primary" style="cursor: pointer;" onclick="location.href='/facility/modify?seq=<%=seq %>'"/>
								<input type="button" value="삭제" class="btn btn-outline-danger" style="cursor: pointer;" onclick="location.href='/facility/delete?seq=<%=seq %>'" />
							</div>
							<% } %>
							<div class="mb-2 pb-3">
								<!-- 업체이름 -->
			...
			<div class="col-8">
				...
				<div class="card text-start">
					...
					<div class="card-body">
						...
						<div class="row mb-3">
							<%
							for ( BoardDTO btoNotice : noticeList ) {
							%>
							...
							<div class="table-responsive">
								<table class="table text-center border-light table-borderless table-sm">
									<thead class="border-light">
										...
										<!-- 사진 -->
											<%
											for ( BoardDTO btoImage : imageList ) {
											%>
